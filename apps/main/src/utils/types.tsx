...
export type ResourceType = 'default' | 'leaderboard' | 'user' | 'users' | 'industry' | 'industries' | 'career' | 'careers' | 'field' | 'fields' | 'skill' | 'skills' | 'topic' | 'topics' | 'question' | 'questions' | 'assessments' | 'assessment'
