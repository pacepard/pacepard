...
import {
    RadioGroup,
    RadioGroupItem,
} from '@pacepard/ui/components/radio-group';
        ...
        const fetchData = async () => {
            try {
                ...
                const workspaceResponse =
                    await PacepardAPI.workspace.getWorkspaces({
                        limit: 1,
                        page: 1,
                        order: 'desc',
                    });
                ...
                if (
                    workspaceResponse.error === false &&
                    workspaceResponse.data?.data?.[0]
                ) {
                    ...
                    >
                        ...
                        <Alert className="bg-red-50 dark:bg-red-950/20 border-red-200 dark:border-red-900">
                            ...
                            <AlertDescription className="text-red-800 dark:text-red-200">
                                ...
                                you would like to add to this team. You've got{' '}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            ...
                                            However, they cannot manage billing.
                                        </p>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            Developer have the ability to access
                                            all the content.
                                        </p>
                                    </div>
                                </div>
