        ...
        <div className="bg-muted relative py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-balance text-3xl font-bold md:text-4xl lg:text-5xl">Pricing</h2>
                    <p className="text-muted-foreground mx-auto mt-4 max-w-xl text-balance text-lg">  Start using Pacepard for free. Upgrade to unlock personalised perks,and additional features.</p>
                </div>
                        ...
                        <div className="@4xl:grid-cols-3 grid">
                            <div>
                                <CardHeader className="p-8">
                                    ...
                                    <span className="mb-0.5 mt-2 block text-2xl font-semibold">₦0 / monthly</span>
                                    <CardDescription className="text-sm">Free for everyone</CardDescription>
                                </CardHeader>
                                <div className="border-y px-8 py-4">
                                    <Button
                                        ...
                                        className="w-full"
                                        variant="default">
                                        <Link href="/join-pacepard">Select Plan</Link>
                                    </Button>
                                </div>
                            ...
                            <div className="ring-foreground/10 bg-background rounded-(--radius) @3xl:mx-0 @3xl:-my-3 -mx-1 border-transparent shadow ring-1">
                                <div className="@3xl:py-3 @3xl:px-0 relative px-1">
                                    <CardHeader className="p-8">
                                        ...
                                        <span className="mb-0.5 mt-2 block text-2xl font-semibold">₦19,900 / monthly</span>
                                    ...
                                    <div className="@3xl:mx-0 -mx-1 border-y px-8 py-4">
                                        <Button
                                            asChild
                                            className="w-full">
                                            <Link href="https://paystack.shop/pay/buysr6duuf">Select Plan</Link>
                                        </Button>
                                    </div>
                            ...
                            <div>
                                <CardHeader className="p-8">
                                    <CardTitle className="font-medium">Builders</CardTitle>
                                    <span className="mb-0.5 mt-2 block text-2xl font-semibold">₦59,900 / monthly</span>
                                    <CardDescription className="text-sm">For Builders</CardDescription>
                                </CardHeader>
                                <div className="border-y px-8 py-4">
                                    <Button
                                        asChild
                                        className="w-full"
                                        variant="default">
                                        <Link href="https://paystack.shop/pay/dkqlreiobj">Select Plan</Link>
                                    </Button>
                                </div>
