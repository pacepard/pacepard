...
function IconTriageBlue() {
    return (
        <span className="flex size-10 items-center justify-center rounded-full bg-blue-500">
            <svg viewBox="0 0 24 24" fill="none" stroke="#111" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="size-6" aria-hidden>
...
function IconReportingGreen() {
    return (
        <span className="flex size-10 items-center justify-center rounded-full bg-green-500">
            <svg viewBox="0 0 24 24" fill="none" stroke="#111" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="size-6" aria-hidden>
                <path d="M4.4 8.1c2.4-1.3 4.4-1.3 7 0v10.3c-2.3-1.4-4.5-1.4-7 0z" fill="white" />
                <path d="M11.4 8.1c2.6-1.3 4.6-1.3 8 0v10.3c-2.8-1.4-5.2-1.4-8 0z" fill="white" />
    ...
    return (
        <span className="flex items-center">
            <span className="flex size-9 items-center justify-center rounded-full bg-blue-500 ring-2 ring-white z-30">
                <svg viewBox="0 0 24 24" fill="none" stroke="#111" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="size-5" aria-hidden>
                    <path d="M5.2 4.8h11.1l-.3 14.3H4.9z" fill="white" />
                    <path d="M5.2 4.8h11.1l-.3 14.3H4.9z" />
                    <path d="m8 12.4 2.1 3.7 4.4-7.2" />
                </svg>
...
export function PPAgentUsecases({
    ...
    return (
        <div className='bg-neutral-50 py-24'>
             <div className={cn('container mx-auto w-full max-w-6xl px-4  md:px-6', className)}>
            {label && (
                <p className="mb-4 text-lg text-muted-foreground">{label}</p>
            )}
                ...
                {useCases.map((item) => (
                    ...
                    >
                        ...
                        <span className={cn(
                            ...
                            item.highlight ? 'text-white' : 'text-muted-foreground',
                        )}>
                            {item.label}{' '}
