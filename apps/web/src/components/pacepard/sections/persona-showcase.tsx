...
const personas = [
  {
    ...
    description: 'Become the person others trust with the hardest customer  and user problems.',
  ...
  },
  {
    id: 'engineers',
    title: 'Engineers',
    description: "Be part of recreating advanced tools like Git, S3 bucket, Redis and SQLite from scratch.",
    image: '/blocks/learners.svg',
  ...
  },
  {
    ...
    description: "Be part of building ML Models and pipelines for the toughest data challenges.",
    image: '/blocks/learners.svg',
    bgColor: 'from-yellow-400 to-yellow-200',
    features: [
      { icon: Wrench, label: 'Open-sourced models' },
...

  {
    ...
    image: '/blocks/learners.svg',
    description: 'Become the safeguard we rely on to uncover hidden failures and security flaws.',
  ...
  },
  {
    ...
    description: 'Become the pillar that generates leads and drives product usage with effective strategies.',
    image: '/blocks/learners.svg',
    bgColor: 'from-blue-300 to-cyan-200',
    features: [
      { icon: Trophy, label: 'ML competition hosting' },
...

  {
    ...
    title: 'Learners',
    image: '/blocks/learners.svg',
    description: 'Projects that go beyond basics and make you understand the underlying complexity.',
    bgColor: 'from-blue-400 to-blue-200',
    features: [
      { icon: Smile, label: 'Beginner competitions' },
      { icon: Wrench, label: 'Practical courses' },
