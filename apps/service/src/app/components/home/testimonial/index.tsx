                            ...
                            <div className="flex flex-col gap-11">
                                <div className="flex flex-col gap-5 ">
                                    ...
                                    <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                        Real experiences, genuine
                                        feedback—discover how our creative
                                        solutions have transformed brands and
                                        elevated businesses.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-7">
                            <div className="bg-primary p-4 lg:p-7 flex flex-col gap-32">
                                ...
                                <div className="flex items-center gap-4">
                                    <Image
                                        src={
                                            '/images/testimonial/testimonial_1.png'
                                        }
                                        alt="Image"
                                        width={60}
                                        height={60}
                            ...
                            <div className="xl:col-span-2 bg-secondary dark:bg-lightgray/10 p-4 lg:p-7 flex flex-col justify-between gap-14">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <Image
                                            src={
                                                '/images/testimonial/testimonial_2.png'
                                            }
                                            alt="Image"
                                            width={60}
                                            height={60}
                                    ...
                                    <div>
                                        <Image
                                            src={
                                                '/images/testimonial/comma_vector.svg'
                                            }
                                            alt="comma"
                                            width={45}
                                            height={45}
                            ...
                            <div className="bg-white dark:bg-black/20 p-4 lg:p-7 flex flex-col justify-between gap-32">
                                ...
                                <div className="flex items-center gap-4">
                                    <Image
                                        src={
                                            '/images/testimonial/testimonial_3.png'
                                        }
                                        alt="Image"
                                        width={60}
                                        height={60}
