                        ...
                        <div className="max-w-md flex flex-col gap-9 md:gap-16">
                            <div className="flex flex-col gap-5 md:gap-8">
                                <p className="max-w-2xl text-secondary/70 dark:text-white/70">
                                    ...
                                    amazing! Tell me about your project—I’m all
                                    ears.
                                </p>
                                <div>
                                    <ul className="flex flex-col gap-3">
                                        {contactData?.keypoint?.map(
                                            (value: any, index: any) => {
                                                return (
                                                    <li
                                                        key={index}
                                ...
                                {submitted && (
                                    <div className="flex gap-1.5">
                                        ...
                                        <p className="text-secondary">
                                            Great!!! Email has been Successfully
                                            Sent. We will get in touch asap.
                                        </p>
                                    </div>
                                )}
                                <div>
