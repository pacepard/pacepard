            ...
            <div className="container">
                <div className="flex flex-col gap-10 justify-center items-center ">
                    <div className="w-full h-full flex justify-center items-center">
                        ...
                        />
                        <Image
                            src={'/images/notfound/404-dark.svg'}
                            alt="Image"
                            height={150}
                            width={550}
                    ...
                    <Link
                        href="/"
                        className="group flex gap-3 items-center w-fit bg-primary hover:bg-secondary dark:border dark:border-primary dark:hover:border dark:hover:border-white/30 rounded-full transition-all duration-200 ease-in-out"
                    >
                        ...
                        <svg
                            className={` py-1 group-hover:-translate-x-[150px] group-hover:rotate-45 transition-all duration-200 ease-in-out `}
                            width="58"
                            height="58"
                            viewBox="0 0 58 58"
                            fill="none"
