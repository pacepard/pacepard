...
export async function generateMetadata({ params }: Props) {
    ...
    const project = getProjectsBySlug(slug, ["title", "ScopeOfWork", "industry", "technology", "website", "description", "coverImage", "gallery", "content"]);
...
export default async function Post({ params }: Props) {
    ...
    const project = getProjectsBySlug(slug, [
        "title", "ScopeOfWork", "industry", "technology", "website", "description", "coverImage", "gallery", "content"
    ]);
