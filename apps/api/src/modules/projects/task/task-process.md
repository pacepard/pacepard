# Task Management Process - Software Specification

This document outlines the complete user journey and system behavior for task processes.

---

## Table of Contents

1. [Create Task Flow](#create-task-flow)
2. [Get Task Flow](#get-task-flow)
3. [Get Tasks by Project Flow](#get-tasks-by-project-flow)
4. [Get Tasks by Team Flow](#get-tasks-by-team-flow)
5. [Get Tasks by Assignee Flow](#get-tasks-by-assignee-flow)
6. [Update Task Flow](#update-task-flow)
7. [Delete Task Flow](#delete-task-flow)
8. [Assign Task Flow](#assign-task-flow)
