...
* **The Question (The Definition):** This is a reusable field definition. It defines the *type* (text, dropdown) and the *label*. A question can exist independently of a form (if you have a question bank).
