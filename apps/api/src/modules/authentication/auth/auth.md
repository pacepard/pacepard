...
all account are user become a usertype profile is created

When they choose to be a TALENT, BUSINESS, MENTOR, JUDGE
they get that profile.
...
a mentor can later go to create a talent account an dthen be onboarded
...
account actitivation haoppens once

so it means there are now 5 user types

each usertype should have their own accept and revoke invite

also create a invite business and invite talent controller
