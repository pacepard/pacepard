...
import { WorkspaceMemberRole } from '../workspace/workspace.interface';
import { ProjectMemberRole } from '../project/project.interface';
...
export const assignProjectRole: RequestHandler = asyncHandler(
    async (req: Request, res: Response, next: NextFunction) => {
        ...
        const projectService = (await import('../project/project.service')).default;
