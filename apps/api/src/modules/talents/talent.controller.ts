 ...
 * @access  Private
 */
export const getTalent = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      if (result.error || !result.data) {
        return next(new ErrorResponse(result.message || "Talent profile not found", result.code || 404, []));
      }
      ...
      res.status(200).json({
        ...
        errors: [],
        data: result.data,
        message: result.message || "Talent profile retrieved successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to retrieve talent profile", 500, []));
    }
  }
);
 ...
 */
export const getTalents = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const {
      page = 1,
      limit = 25,
    ...
    try {
      ...
      const result = await talentRepository.getTalents(filters as any, options);
      ...
      res.status(200).json({
        ...
        count: result.count,
        total: result.total,
        message: result.message || "Talents retrieved successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to retrieve talents", 500, []));
    }
  }
);
 ...
 * @access  Private
 */
export const updateTalent = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const userId = (req as any).user?.id;
    if (!userId) return next(new ErrorResponse("Unauthorized", 401, []));
    ...
    try {
      ...
      res.status(200).json({
        ...
        errors: [],
        data: result.data,
        message: result.message || "Talent profile updated successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to update talent profile", 500, []));
    }
  }
);
 ...
 * @access  Private
 */
export const updateInterests = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const userId = (req as any).user?.id;
    if (!userId) return next(new ErrorResponse("Unauthorized", 401, []));
    ...
    try {
      ...
      const result = await talentService.updateInterests(String(userId), interests as string[]);
      ...
      res.status(200).json({
        ...
        errors: [],
        data: result.data,
        message: result.message || "Interests updated successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to update interests", 500, []));
    }
  }
);
  ...
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      res.status(200).json({
        ...
        errors: [],
        data: result.data,
        message: result.message || "Skill added successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to add skill", 500, []));
    }
  }
);
 ...
 * @access  Private
 */
export const removeSkill = asyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const userId = (req as any).user?.id;
    if (!userId) return next(new ErrorResponse("Unauthorized", 401, []));
    ...
    try {
      ...
      res.status(200).json({
        ...
        errors: [],
        data: result.data,
        message: result.message || "Skill removed successfully.",
        status: 200,
      });
    } catch (error: any) {
      return next(new ErrorResponse(error.message || "Failed to remove skill", 500, []));
    }
  }
);
