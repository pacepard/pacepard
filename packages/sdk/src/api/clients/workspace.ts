...
class WorkspaceAPI {
    ...
    inviteMember(payload: { workspaceId: string; email: string }): Promise<IAPIResponse> {
        return this.axiosService.call({
            type: 'default',
            method: 'POST',
            path: `${URL_WORKSPACE}/${payload.workspaceId}/invite`,
            isAuth: true,
            payload: {
    ...
    bulkInviteMembers(payload: { workspaceId: string; emails: string[] }): Promise<IAPIResponse> {
        return this.axiosService.call({
            type: 'default',
            method: 'POST',
            path: `${URL_WORKSPACE}/${payload.workspaceId}/invite/bulk`,
            isAuth: true,
            payload: {
                workspaceId: payload.workspaceId,
    ...
    updateDomainAccess(payload: {
        ...
        return this.axiosService.call({
            type: 'default',
            method: 'PUT',
            path: `${URL_WORKSPACE}/${payload.workspaceId}/domain-access`,
            isAuth: true,
            payload: {
                allowDomainAccess: payload.allowDomainAccess,
    ...
    generateShareableLink(payload: {
        ...
        return this.axiosService.call({
            type: 'default',
            method: 'POST',
            path: `${URL_WORKSPACE}/${payload.workspaceId}/invite/shareable-link`,
            isAuth: true,
            payload: {
    ...
    joinWorkspaceByLink(payload: {
        ...
        return this.axiosService.call({
            type: 'default',
            method: 'POST',
            path: `${URL_WORKSPACE}/invite/join`,
            isAuth: true,
            payload: {
                token: payload.token,
                workspaceId: payload.workspaceId,
