...
import '@pacepard/blocs/core/node/form-input/form-input.scss';
import '@pacepard/blocs/core/node/input-title-node/input-title-node.scss';
import '@pacepard/blocs/core/node/input-label-node/input-label-node.scss';
...
export function EditorProvider(props: EditorProviderProps) {
    ...
    const editor = useEditor({
        ...
        extensions: [
            ...
            CodeBlockShiki.configure({ defaultLanguage: 'javascript' }),
            HorizontalRule,
 ...
 */
export function PacepardEditorContent({
    placeholder,
}: {
    placeholder?: string;
}) {
