...
import { isValidPosition, findNodePosition } from './base-helper';
 ...
 */
function hasContentAbove(editor: Editor | null): {
    hasContent: boolean;
    content: string;
} {
 ...
 */
function getSelectedDOMElement(editor: Editor): HTMLElement | null {
 ...
 */
function getClosestBlockNode(editor: Editor | null) {
 ...
 */
function getClosestNodeByName(editor: Editor | null, nodeName: string) {
 ...
 */
function selectionHasText(editor: Editor | null): boolean {
 ...
 */
function getEditorExtension(editor: Editor | null, extensionName: string) {
    if (!editor) return null;
