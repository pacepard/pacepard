...
import { TEXT_COLORS, ColorTextButton } from '@/core/ui/color-text-button';
import {
    HIGHLIGHT_COLORS,
...
// --- Utils ---
import { chunkArray } from '@/utils/advanced-helper';

// --- Styles ---
import '@/core/ui/color-text-popover/color-text-popover.scss';
