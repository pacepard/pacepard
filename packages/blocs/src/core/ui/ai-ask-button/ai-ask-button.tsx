...
// --- TIptap UI ---
import type { UseAiAskConfig } from '@/core/ui/ai-ask-button';
import { AI_ASK_SHORTCUT_KEY, useAiAsk } from '@/core/ui/ai-ask-button';
...
export interface AiAskButtonProps
    extends Omit<ButtonProps, 'type'>, UseAiAskConfig {
    /**
