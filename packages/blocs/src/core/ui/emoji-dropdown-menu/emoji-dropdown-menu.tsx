...
import { EmojiMenuItem, getFilteredEmojis } from '@/core/ui/emoji-menu';
import { Card, CardBody } from '@/core/primitives/card';
import { ButtonGroup } from '@/core/primitives/button';
...
const getSuggestionItems = async (props: { query: string; editor: Editor }) => {
    const emojis: EmojiItem[] =
        props.editor.extensionStorage.emoji.emojis || [];
