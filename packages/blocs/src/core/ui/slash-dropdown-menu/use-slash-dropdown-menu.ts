...
// --- Lib ---
import { isExtensionAvailable, isNodeInSchema } from '@/utils/base-helper';
import {
...
const getItemImplementations = () => {
    return {
        ...
        short_answer: {
            check: (editor: Editor) =>
                isNodeInSchema('shortAnswerText', editor),
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertShortAnswerText({ placeholder: 'Type a question' })
                    .run();
            },
        },
        short_answer_email: {
            check: (editor: Editor) =>
                isNodeInSchema('shortAnswerEmail', editor),
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertShortAnswerEmail({ placeholder: 'name@example.com' })
                    .run();
            },
        },
        short_answer_number: {
            check: (editor: Editor) =>
                isNodeInSchema('shortAnswerNumber', editor),
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertShortAnswerNumber({ placeholder: '0' })
                    .run();
            },
        },
        short_answer_url: {
        ...
        form_input_text: {
            ...
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertFormInputText({ placeholder: 'Type a question' })
                    .run();
            },
        },
        form_input_email: {
            ...
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertFormInputEmail({ placeholder: 'name@example.com' })
                    .run();
            },
        },
        form_input_number: {
            check: (editor: Editor) =>
                isNodeInSchema('formInputNumber', editor),
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertFormInputNumber({ placeholder: '0' })
                    .run();
            },
        },
        form_input_url: {
            ...
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertFormInputUrl({ placeholder: 'https://example.com' })
                    .run();
            },
        },
        form_input_phone: {
        ...
        long_answer: {
            ...
            action: ({ editor }: { editor: Editor }) => {
                editor
                    .chain()
                    .focus()
                    .insertLongAnswer({ placeholder: 'Type your answer...' })
                    .run();
            },
        },
    };
