...
// --- Lib ---
import { getElementOverflowPosition } from '@/utils/collab-helper';
...
} from '@/utils/suggestion-menu';
import { filterSuggestionItems } from '@/utils/suggestion-menu';
import { SuggestionMenu } from '@/utils/suggestion-menu';

// --- Hooks ---
import type { SlashMenuConfig } from '@/core/ui/slash-dropdown-menu/use-slash-dropdown-menu';
import { useSlashDropdownMenu } from '@/core/ui/slash-dropdown-menu/use-slash-dropdown-menu';
...
import '@/core/ui/slash-dropdown-menu/slash-dropdown-menu.scss';
