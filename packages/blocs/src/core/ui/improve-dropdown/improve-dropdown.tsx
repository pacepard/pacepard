...
// --- Hooks ---
import { useImproveDropdown, type AICommand } from '@/core/ui/improve-dropdown';

// --- Icons ---
import { MicAiIcon } from '@/core/icons/mic-ai-icon';
import { AiSparklesIcon } from '@/core/icons/ai-sparkles-icon';
import { CheckAiIcon } from '@/core/icons/check-ai-icon';
import { TextExtendIcon } from '@/core/icons/text-extend-icon';
import { TextReduceIcon } from '@/core/icons/text-reduce-icon';
import { Simplify2Icon } from '@/core/icons/simplify-2-icon';
import { SmileAiIcon } from '@/core/icons/smile-ai-icon';
import { CompleteSentenceIcon } from '@/core/icons/complete-sentence-icon';
import { SummarizeTextIcon } from '@/core/icons/summarize-text-icon';
import { LanguagesIcon } from '@/core/icons/languages-icon';
import { ChevronRightIcon } from '@/core/icons/chevron-right-icon';

// --- Tiptap UI ---
import { SUPPORTED_LANGUAGES, SUPPORTED_TONES } from '@/core/ui/ai-menu';
import { AiAskButton } from '@/core/ui/ai-ask-button';
