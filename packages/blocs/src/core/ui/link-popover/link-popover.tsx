...
// --- Icons ---
import { CornerDownLeftIcon } from '@/core/icons/corner-down-left-icon';
import { ExternalLinkIcon } from '@/core/icons/external-link-icon';
import { LinkIcon } from '@/core/icons/link-icon';
import { TrashIcon } from '@/core/icons/trash-icon';

// --- Tiptap UI ---
import type { UseLinkPopoverConfig } from '@/core/ui/link-popover';
import { useLinkPopover } from '@/core/ui/link-popover';
...
import { Card, CardBody, CardItemGroup } from '@/core/primitives/card';
import { Input, InputGroup } from '@/core/primitives/input';
