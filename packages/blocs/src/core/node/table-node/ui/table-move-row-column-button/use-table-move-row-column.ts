...
// --- Icons ---
import { ArrowLeftIcon } from '@/core/icons/arrow-left-icon';
import { ArrowRightIcon } from '@/core/icons/arrow-right-icon';
import { ArrowUpIcon } from '@/core/icons/arrow-up-icon';
import { ArrowDownIcon } from '@/core/icons/arrow-down-icon';
...
function canMoveRowColumn({
    ...
    try {
        ...
        const { orientation: finalOrientation, index: finalIndex } =
            selectionType;
