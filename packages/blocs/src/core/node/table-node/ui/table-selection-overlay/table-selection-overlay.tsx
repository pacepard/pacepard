...
import { useResizeOverlay } from '@/core/node/table-node/ui/table-selection-overlay/use-resize-overlay';
        ...
        (handle: ResizeHandle) => (event: React.MouseEvent) => {
            ...
            const handleMouseMove = (mouseEvent: MouseEvent) => {
                ...
                try {
                    ...
                    console.debug(
                        'Invalid cell selection during resize:',
                        error,
                    );
                }
            };
