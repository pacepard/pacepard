...
// --- Icons ---
import { TableColumnIcon } from '@/core/icons/table-column-icon';
import { TableRowIcon } from '@/core/icons/table-row-icon';
    ...
    return (
        <div className="tiptap-table-size-indicator">
            <div className="tiptap-table-size-indicator-item">
                ...
                <span className="tiptap-table-size-indicator-text">
                    {columns}
                </span>
            </div>
    ...
    (
        ...
        return (
            <>
                ...
                {showSizeIndicator && (
                    <SizeIndicator hoveredCell={hoveredCell} />
                )}
            </>
        );
    },
