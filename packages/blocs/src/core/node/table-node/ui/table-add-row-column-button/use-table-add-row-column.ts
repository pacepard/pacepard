...
// --- Icons ---
import { AddColLeftIcon } from '@/core/icons/add-col-left-icon';
import { AddColRightIcon } from '@/core/icons/add-col-right-icon';
import { AddRowBottomIcon } from '@/core/icons/add-row-bottom-icon';
import { AddRowTopIcon } from '@/core/icons/add-row-top-icon';
...
function tableAddRowColumn({
    ...
    try {
        ...
        if (editor.state.selection instanceof CellSelection) {
            ...
            const cellState = selectCellsByCoords(
                editor,
                table.pos,
                [cellCoords],
                {
