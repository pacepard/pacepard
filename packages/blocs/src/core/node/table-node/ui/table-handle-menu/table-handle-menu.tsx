...
import { cn, isValidPosition, SR_ONLY } from '@/utils/base-helper';
import type { Orientation } from '@/core/node/table-node/lib/tiptap-table-utils';
import { selectCellsByCoords } from '@/core/node/table-node/lib/tiptap-table-utils';

// --- Icons ---
import { MoreVerticalIcon } from '@/core/icons/more-vertical-icon';
...
// --- Tiptap UI ---
import { useTableDuplicateRowColumn } from '@/core/node/table-node/ui/table-duplicate-row-column-button';
...
import { useTableHeaderRowColumn } from '@/core/node/table-node/ui/table-header-row-column-button';
import { useTableAddRowColumn } from '@/core/node/table-node/ui/table-add-row-column-button';
import { useTableDeleteRowColumn } from '@/core/node/table-node/ui/table-delete-row-column-button';
...
import { dragEnd } from '@/core/node/table-node/extensions/table-handle';
                ...
                <MenuGroup>
                    ...
                    {clearContentAction.isVisible && (
                        <TableActionItem
                            ...
                            disabled={
                                !clearContentAction.canClearRowColumnContent
                            }
