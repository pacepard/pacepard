...
declare module "@tiptap/core" {
  interface Commands<ReturnType> {
    inputTitle: {
      setInputTitle: (attrs?: { level?: number; placeholder?: string }) => ReturnType
      toggleInputTitle: (attrs?: { level?: number; placeholder?: string }) => ReturnType
    }
  }
}
  ...
  addAttributes() {
    return {
      ...
      placeholder: {
        ...
        parseHTML: (element) => element.getAttribute("data-placeholder") ?? DEFAULT_PLACEHOLDER,
        renderHTML: (attrs) => ({ "data-placeholder": attrs.placeholder ?? DEFAULT_PLACEHOLDER }),
      },
    }
  },
