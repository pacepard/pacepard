...
import { getSelectedNodesOfType } from '@/utils/base-helper';
import { updateNodesAttr } from '@/utils/base-helper';
                ...
                attributes: {
                    nodeTextAlign: {
                        ...
                        parseHTML: (element: HTMLElement) => {
                            ...
                            if (
                                styleAlign &&
                                this.options.textAlignValues.includes(
                                    styleAlign,
                                )
                            ) {
                                return styleAlign;
                        ...
                        renderHTML: (attributes) => {
                            const align = attributes.nodeTextAlign as
                                | string
                                | null;
                            if (
                                !align ||
                                !this.options.textAlignValues.includes(align)
                            )
                                return {};
                    ...
                    nodeVerticalAlign: {
                        ...
                        parseHTML: (element: HTMLElement) => {
                            ...
                            if (
                                styleVAlign &&
                                this.options.verticalAlignValues.includes(
                                    styleVAlign,
                                )
                            ) {
                                return styleVAlign;
                        ...
                        renderHTML: (attributes) => {
                            const vAlign = attributes.nodeVerticalAlign as
                                | string
                                | null;
                            if (
                                !vAlign ||
        ...
        return {
            ...
            setNodeTextAlign: executeAlignmentCommand(
                ...
                (_, inputValue) => {
                    if (
                        !inputValue ||
                        !this.options.textAlignValues.includes(inputValue)
                    )
                        return null;
                    return inputValue;
                },
            ),
            unsetNodeTextAlign: executeAlignmentCommand(
                'nodeTextAlign',
                () => null,
            ),
            ...
            unsetNodeVAlign: executeAlignmentCommand(
                'nodeVerticalAlign',
                () => null,
            ),
            ...
            setNodeAlignment:
                ...
                ({ state, tr }: { state: EditorState; tr: Transaction }) => {
                    ...
                    for (const { node, pos } of targets) {
                        ...
                        if (
                            textAlign &&
                            this.options.textAlignValues.includes(textAlign)
                        ) {
