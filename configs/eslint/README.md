...
```js
import { baseConfig } from '@pacepard/configs/eslint/base'
import { nextConfig } from '@pacepard/configs/eslint/next'
...
```js
import { baseConfig } from '@pacepard/configs/eslint/base'
import { reactInternalConfig } from '@pacepard/configs/eslint/react-internal'
